...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    categoryBooks = books.filter((book) => {
      ...
      return (
        ...
        category.includes(targetCategory) ||
        category.includes("language") ||
        category.includes("foreign") ||
        category.includes("ngoai ngu")
      );
    });
  ...
  /* =====================================================
     ...
     bookMarkButton.js PHẢI LOAD TRƯỚC FILE NÀY
  ===================================================== */
  ...
  if (
    ...
    console.error(
      "bookMarkButton.js chưa được load trước language.js",
    );
  ...
  /* =====================================================
     ...
     BOOKMARK DÙNG CHUNG bookMarkButton.js
  ===================================================== */
