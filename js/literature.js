...
document.addEventListener("DOMContentLoaded", async () => {
  console.log("=================================");
  console.log("LITERATURE.JS START");
  ...
  /* =====================================================
     ...
     PHẢI LOAD bookMarkButton.js TRƯỚC literature.js
  ===================================================== */
  ...
  if (
    ...
    console.error(
      "bookMarkButton.js chưa được load trước literature.js",
    );
  ...
  /* =====================================================
     ...
     BOOKMARK DÙNG bookMarkButton.js
  ===================================================== */
